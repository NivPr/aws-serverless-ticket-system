...
function createApiGateway(scope, lambdaFunction) {
  ...
  const authorizer = new apigateway.CognitoUserPoolsAuthorizer(scope, 'MyCognitoAuthorizer', {
  ...
  tickets.addMethod('GET', new apigateway.LambdaIntegration(lambdaFunction), {
    authorizer,
    authorizationType: apigateway.AuthorizationType.COGNITO,
  });
