...
exports.handler = async (event) => {
  ...
  try {
    ...
    // PUT /tickets/edit
    if (method === "PUT" && path.endsWith("/tickets/edit")) {
      if (!ticketId) {
        return {
          statusCode: 400,
      ...
      const result = await updateTicket(ticketId, userId, updatedFields);
      return {
        statusCode: 200,
        body: JSON.stringify({ message: "Ticket updated", data: result })
      };
    }
