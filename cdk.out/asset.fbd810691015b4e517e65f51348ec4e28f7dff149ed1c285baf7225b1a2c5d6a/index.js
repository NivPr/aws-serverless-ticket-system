...
exports.handler = async (event) => {
  try {
    ...
    console.log("DEBUG:", { httpMethod, rawPath, normalizedPath, stage });

    const body = event.body ? JSON.parse(event.body) : {};

    switch (true) {
      case httpMethod === "POST" && normalizedPath === "/auth/signUp":
        {
      ...
      case httpMethod === "POST" && normalizedPath === "/auth/signIn":
        {
      ...
      case httpMethod === "POST" && normalizedPath === "/auth/confirmSignUp":
        {
          ...
          return {
            statusCode: 200,
            body: JSON.stringify({ message: "ConfirmSignUp successful", data: result.AuthenticationResult }),
          };
        }
      default:
        return {
